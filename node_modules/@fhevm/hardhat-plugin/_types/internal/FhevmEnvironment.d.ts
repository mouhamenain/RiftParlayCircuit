import { CoprocessorConfig, FhevmContractName, FhevmMockProvider, MinimalProvider, MockCoprocessor, contracts } from "@fhevm/mock-utils";
...
export declare class FhevmEnvironment {
    ...
    getACLAddress(): `0x${string}`;
    getFHEVMExecutorAddress(): `0x${string}`;
    getInputVerifierAddress(): `0x${string}`;
    getCoprocessorSigners(): EthersT.Signer[] | undefined;
    getCoprocessorSignersOrThrow(): EthersT.Signer[];
    getKMSVerifierAddress(): `0x${string}`;
    getKMSSigners(): EthersT.Signer[] | undefined;
    getKMSSignersOrThrow(): EthersT.Signer[];
    /**
     ...
     */
    getGatewayInputVerificationAddress(): `0x${string}`;
    /**
     ...
     */
    getGatewayDecryptionAddress(): `0x${string}`;
