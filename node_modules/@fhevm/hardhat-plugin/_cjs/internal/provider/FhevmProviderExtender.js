...
class FhevmProviderExtender extends plugins_1.ProviderWrapper {
    constructor(_wrappedProvider, _config, _network, _blockNumber) {
        ...
        this._provider = new ethers_1.ethers.BrowserProvider(this._wrappedProvider);
    }
    async request(args) {
        switch (args.method) {
    ...
    async _handleFhevmRelayerV1PublicDecrypt(args) {
        ...
        await mock_utils_1.MockFhevmInstance.verifyPublicACLPermissions(this._provider, fhevmEnv.getACLAddress(), payload.ciphertextHandles);
    ...
    async _handleFhevmRelayerV1UserDecrypt(args) {
        ...
        await mock_utils_1.MockFhevmInstance.verifyUserACLPermissions(this._provider, fhevmEnv.getACLAddress(), payload.handleContractPairs, payload.userAddress);
