...
exports.getPrecompiledFhevmHostContractsAddresses = getPrecompiledFhevmHostContractsAddresses;
exports.retrievePreCompiledFHEVMExecutorAddressFromACLArtifact = retrievePreCompiledFHEVMExecutorAddressFromACLArtifact;
exports.loadPrecompiledFhevmHostContractsAddresses = loadPrecompiledFhevmHostContractsAddresses;
...
async function getPrecompiledFhevmHostContractsAddresses(mockProvider, fhevmPaths) {
    debug(`Resolving precompiled @fhevm/host-contracts addresses using artifacts at ${fhevmPaths.resolveFhevmHostContractsArtifactRootDir()} ...`);
    if (mockProvider.info.networkName !== "hardhat") {
        throw new error_1.HardhatFhevmError(`Can't retrieve ${constants_1.default.FHEVM_HOST_CONTRACTS_PACKAGE.name} precompiled addresses. This operation is only supported on 'hardhat' network. Current network: ${mockProvider.info.networkName}`);
    }
...
async function loadPrecompiledFhevmHostContractsAddresses(mockProvider, fhevmPaths, ignoreCache, isRunningInHHFHEVMInstallSolidity) {
...
//# sourceMappingURL=PrecompiledFhevmHostContracts.js.map