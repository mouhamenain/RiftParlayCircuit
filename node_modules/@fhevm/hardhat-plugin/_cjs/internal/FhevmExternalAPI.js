...
class FhevmExternalAPI {
    ...
    async userDecryptEbool(handleBytes32, contractAddress, user, options) {
        (0, mock_utils_1.assertIsFhevmHandleBytes32Hex)(handleBytes32, "handleBytes32");
    ...
    async publicDecryptEbool(handleBytes32, options) {
        ...
        if (typeof decryptedResults.clearValues[handleBytes32] !== "boolean") {
            throw new error_1.HardhatFhevmError(`Unexpected type for decrypted value of ebool handle '${handleBytes32}': expected a boolean, but got '${typeof decryptedResults.clearValues[handleBytes32]}' instead.`);
        }
    ...
    async publicDecryptEuint(fhevmType, handleBytes32, options) {
        ...
        if (typeof decryptedResults.clearValues[handleBytes32] !== "bigint") {
            throw new error_1.HardhatFhevmError(`Unexpected type for decrypted value of ${fhevmTypeInfo.name} handle '${handleBytes32}': expected a bigint, but got '${typeof decryptedResults.clearValues[handleBytes32]}' instead.`);
        }
        return decryptedResults.clearValues[handleBytes32];
    }
    ...
    async publicDecryptEaddress(handleBytes32, options) {
        ...
        if (typeof decryptedResults.clearValues[handleBytes32] !== "string") {
            throw new error_1.HardhatFhevmError(`Unexpected type for decrypted value of eaddress handle '${handleBytes32}': expected a hex string, but got '${typeof decryptedResults.clearValues[handleBytes32]}' instead.`);
        }
        if (!ethers_1.ethers.isAddress(decryptedResults.clearValues[handleBytes32])) {
            throw new error_1.HardhatFhevmError(`publicDecryptEaddress failed. Decrypted value is not a valid address. Got ${decryptedResults.clearValues[handleBytes32]}.`);
        }
        return decryptedResults.clearValues[handleBytes32];
    }
