...
export function assertIs0xString(value, valueName) {
    assertFhevm(typeof value === "string" && value.startsWith("0x"), `${valueName ?? "value"} is not of type \`0x\${string}\`, got ${typeof value} instead`);
}
