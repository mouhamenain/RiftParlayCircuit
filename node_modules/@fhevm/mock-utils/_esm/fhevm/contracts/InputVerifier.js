...
export class InputVerifier extends FhevmHostContractWrapper {
    ...
    async _initialize() {
        ...
        assertIsAddressArray(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f"));
    ...
    async _reorderCoprocessorSigners() {
        assertFhevm(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f"));
    ...
    get gatewayInputVerificationAddress() {
        assertFhevm(__classPrivateFieldGet(this, _InputVerifier_eip712Domain, "f") !== undefined, `InputVerifier wrapper not initialized`);
        assertIsAddress(__classPrivateFieldGet(this, _InputVerifier_eip712Domain, "f").verifyingContract, "InputVerifier.eip712Domain.verifyingContract");
    ...
    getCoprocessorSignersAddresses() {
        assertFhevm(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f") !== undefined, `InputVerifier wrapper not initialized`);
    ...
    verifySignatures(handlesBytes32List, userAddress, contractAddress, contractChainId, extraData, signatures) {
        ...
        if (!isThresholdReached(this.getCoprocessorSignersAddresses(), recoveredAddresses, this.getThreshold(), "coprocessor")) {
