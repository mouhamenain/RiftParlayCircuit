...
export class MockCoprocessor {
    ...
    static async create(readonlyProvider, params) {
        ...
        __classPrivateFieldSet(mc, _MockCoprocessor_eventsIterator, new CoprocessorEventsIterator(coprocessorItf, params.coprocessorContractAddress, readonlyProvider, params.db.fromBlockNumber), "f");
        ...
        __classPrivateFieldSet(mc, _MockCoprocessor_inputVerifier, await InputVerifier.create(readonlyProvider, params.inputVerifierContractAddress, undefined, {
    ...
    async awaitCoprocessor() {
        assertFhevm(__classPrivateFieldGet(this, _MockCoprocessor_eventsIterator, "f") !== undefined, `MockCoprocessor not initialized`);
