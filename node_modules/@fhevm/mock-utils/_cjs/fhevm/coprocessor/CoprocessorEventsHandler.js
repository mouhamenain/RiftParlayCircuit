...
class CoprocessorEventsHandler {
    ...
    async verifyInput(eventArgs) {
        ...
        (0, event_js_1.assertEventArgIsBytes32String)(inputHandleBytes32, "VerifyInput", 1);
        (0, event_js_1.assertEventArgIsAddress)(userAddress, "VerifyInput", 2);
        (0, event_js_1.assertEventArgIsBytesString)(inputProofBytes, "VerifyInput", 3);
        (0, event_js_1.assertEventArgIsBigUint256)(fheType, "VerifyInput", 4);
        (0, event_js_1.assertEventArgIsBytes32String)(resultBytes32, "v", 5);
        (0, error_js_1.assertFhevm)(inputHandleBytes32 === resultBytes32, `VerifyInput: inputHandleBytes32=${inputHandleBytes32} differs from resultBytes32=${resultBytes32}`);
        try {
