...
var _MockCoprocessor_eventsIterator, _MockCoprocessor_handler, _MockCoprocessor_db, _MockCoprocessor_coprocessorSigners, _MockCoprocessor_inputVerifier;
...
class MockCoprocessor {
    constructor() {
        _MockCoprocessor_eventsIterator.set(this, void 0);
    ...
    static async create(readonlyProvider, params) {
        ...
        __classPrivateFieldSet(mc, _MockCoprocessor_eventsIterator, new CoprocessorEventsIterator_js_1.CoprocessorEventsIterator(coprocessorItf, params.coprocessorContractAddress, readonlyProvider, params.db.fromBlockNumber), "f");
        ...
        __classPrivateFieldSet(mc, _MockCoprocessor_inputVerifier, await InputVerifier_js_1.InputVerifier.create(readonlyProvider, params.inputVerifierContractAddress, undefined, {
    ...
    async awaitCoprocessor() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _MockCoprocessor_eventsIterator, "f") !== undefined, `MockCoprocessor not initialized`);
        ...
        const events = await __classPrivateFieldGet(this, _MockCoprocessor_eventsIterator, "f").next();
...
_MockCoprocessor_eventsIterator = new WeakMap(), _MockCoprocessor_handler = new WeakMap(), _MockCoprocessor_db = new WeakMap(), _MockCoprocessor_coprocessorSigners = new WeakMap(), _MockCoprocessor_inputVerifier = new WeakMap();
