...
var _InputVerifier_inputVerifierReadonlyContract, _InputVerifier_inputVerifierContractAddress, _InputVerifier_orderedSignersAddresses, _InputVerifier_orderedSigners, _InputVerifier_threshold, _InputVerifier_eip712Domain;
...
class InputVerifier extends FhevmContractWrapper_js_1.FhevmHostContractWrapper {
    constructor() {
        super("InputVerifier");
        _InputVerifier_inputVerifierReadonlyContract.set(this, void 0);
        _InputVerifier_inputVerifierContractAddress.set(this, void 0);
        _InputVerifier_orderedSignersAddresses.set(this, void 0);
        _InputVerifier_orderedSigners.set(this, void 0);
    ...
    static async create(runner, inputVerifierContractAddress, abi, properties) {
        ...
        __classPrivateFieldSet(inputVerifier, _InputVerifier_orderedSignersAddresses, properties?.signersAddresses
            ? [...properties.signersAddresses]
            : undefined, "f");
        __classPrivateFieldSet(inputVerifier, _InputVerifier_orderedSigners, properties?.signers ? [...properties.signers] : undefined, "f");
        __classPrivateFieldSet(inputVerifier, _InputVerifier_threshold, properties?.threshold, "f");
        await inputVerifier._initialize();
        return inputVerifier;
    }
    get inputVerifierProperties() {
        return {
            ...(__classPrivateFieldGet(this, _InputVerifier_eip712Domain, "f") ? { eip712Domain: { ...__classPrivateFieldGet(this, _InputVerifier_eip712Domain, "f") } } : {}),
            ...(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f") ? { signersAddresses: [...__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f")] } : {}),
            ...(__classPrivateFieldGet(this, _InputVerifier_orderedSigners, "f") ? { signers: [...__classPrivateFieldGet(this, _InputVerifier_orderedSigners, "f")] } : {}),
            ...(__classPrivateFieldGet(this, _InputVerifier_threshold, "f") !== undefined ? { threshold: __classPrivateFieldGet(this, _InputVerifier_threshold, "f") } : {}),
        };
    }
    ...
    async _initialize() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _InputVerifier_inputVerifierReadonlyContract, "f") !== undefined, `InputVerifier wrapper is not initialized`);
        if (!__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f")) {
            const signers = await __classPrivateFieldGet(this, _InputVerifier_inputVerifierReadonlyContract, "f").getCoprocessorSigners();
            __classPrivateFieldSet(this, _InputVerifier_orderedSignersAddresses, signers, "f");
        }
        (0, address_js_1.assertIsAddressArray)(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f"));
    ...
    async _reorderCoprocessorSigners() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f"));
        const orderedAddresses = new Set();
        for (let i = 0; i < __classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f").length; ++i) {
            const addr = __classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f")[i];
            if (orderedAddresses.has(addr)) {
                throw new error_js_1.FhevmError(`Duplicated kms signer address ${addr}`);
            }
            orderedAddresses.add(addr);
        }
        if (!__classPrivateFieldGet(this, _InputVerifier_orderedSigners, "f")) {
            return;
        }
        const addressSignerPairs = await Promise.all(__classPrivateFieldGet(this, _InputVerifier_orderedSigners, "f").map(async (signer) => {
        ...
        __classPrivateFieldSet(this, _InputVerifier_orderedSigners, newOrderedSigners, "f");
    }
    get address() {
    ...
    get gatewayInputVerificationAddress() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _InputVerifier_eip712Domain, "f") !== undefined, `InputVerifier wrapper not initialized`);
        (0, address_js_1.assertIsAddress)(__classPrivateFieldGet(this, _InputVerifier_eip712Domain, "f").verifyingContract, "InputVerifier.eip712Domain.verifyingContract");
    ...
    getCoprocessorSignersAddresses() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f") !== undefined, `InputVerifier wrapper not initialized`);
        return __classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f");
    }
    getCoprocessorSigners() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _InputVerifier_orderedSignersAddresses, "f") !== undefined, `InputVerifier wrapper not initialized`);
        return __classPrivateFieldGet(this, _InputVerifier_orderedSigners, "f");
    }
    getThreshold() {
    ...
    verifySignatures(handlesBytes32List, userAddress, contractAddress, contractChainId, extraData, signatures) {
        ...
        if (!(0, eip712_js_1.isThresholdReached)(this.getCoprocessorSignersAddresses(), recoveredAddresses, this.getThreshold(), "coprocessor")) {
...
_InputVerifier_inputVerifierReadonlyContract = new WeakMap(), _InputVerifier_inputVerifierContractAddress = new WeakMap(), _InputVerifier_orderedSignersAddresses = new WeakMap(), _InputVerifier_orderedSigners = new WeakMap(), _InputVerifier_threshold = new WeakMap(), _InputVerifier_eip712Domain = new WeakMap();
