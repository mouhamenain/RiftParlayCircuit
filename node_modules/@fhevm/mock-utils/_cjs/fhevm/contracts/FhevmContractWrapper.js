...
exports.FhevmHostContractWrapper = exports.FhevmContractWrapper = void 0;
...
exports.FhevmContractWrapper = FhevmContractWrapper;
_FhevmContractWrapper_name = new WeakMap();
class FhevmHostContractWrapper extends FhevmContractWrapper {
    constructor(name) {
        super(name);
    }
    get package() {
        return constants_js_1.default.FHEVM_HOST_CONTRACTS_PACKAGE_NAME;
    }
}
exports.FhevmHostContractWrapper = FhevmHostContractWrapper;
