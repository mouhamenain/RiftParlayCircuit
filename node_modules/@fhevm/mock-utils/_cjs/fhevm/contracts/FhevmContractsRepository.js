...
class FhevmContractsRepository {
    ...
    static async create(ethersReadonlyProvider, config) {
        ...
        __classPrivateFieldSet(repo, _FhevmContractsRepository_inputVerifier, await InputVerifier_js_1.InputVerifier.create(ethersReadonlyProvider, __classPrivateFieldGet(repo, _FhevmContractsRepository_fhevmExecutor, "f").inputVerifierAddress, config.inputVerifierAbi, config.inputVerifierProperties), "f");
        __classPrivateFieldSet(repo, _FhevmContractsRepository_kmsVerifier, await KMSVerifier_js_1.KMSVerifier.create(ethersReadonlyProvider, config.kmsContractAddress, config.kmsVerifierAbi, config.kmsVerifierProperties), "f");
        __classPrivateFieldSet(repo, _FhevmContractsRepository_hcuLimit, await HCULimit_js_1.HCULimit.create(ethersReadonlyProvider, __classPrivateFieldGet(repo, _FhevmContractsRepository_fhevmExecutor, "f").hcuLimitAddress, config.hcuLimitAbi, config.hcuLimitProperties), "f");
