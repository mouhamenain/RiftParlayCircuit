...
const hcu_js_1 = require("../coprocessor/hcu.js");
...
class FHEVMExecutor extends FhevmContractWrapper_js_1.FhevmHostContractWrapper {
    constructor() {
        super("FHEVMExecutor");
    ...
    computeTransactionHCU(transactionReceipt) {
        return (0, hcu_js_1.getTxHCUFromTxReceipt)(this.address, this.readonlyContract.interface, transactionReceipt);
    }
}
