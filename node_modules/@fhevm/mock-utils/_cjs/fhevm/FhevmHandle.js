...
function assertIsFhevmHandleBytes32Hex(value, valueName) {
    (0, bytes_js_1.assertIsBytes32String)(value, valueName);
...
class FhevmHandle {
    ...
    static _computeInputHash21(blobHashBytes32, aclAddress, chainId, index) {
        ...
        return ethers_1.ethers.keccak256((0, bytes_js_1.concatBytes)(domainSepBytes, blobHashBytes32, encryptionIndex1Byte, aclContractAddress20Bytes, chainId32Bytes));
    }
    ...
    static computeHandles(ciphertextWithZKProof, fhevmTypes, aclContractAddress, chainId, ciphertextVersion) {
        ...
        const blobHashBytes32Hex = ethers_1.ethers.keccak256((0, bytes_js_1.concatBytes)(domainSepBytes, ciphertextWithZKProof));
