...
function assertIs0xString(value, valueName) {
    (0, error_js_1.assertFhevm)(typeof value === "string" && value.startsWith("0x"), `${valueName ?? "value"} is not of type \`0x\${string}\`, got ${typeof value} instead`);
}
