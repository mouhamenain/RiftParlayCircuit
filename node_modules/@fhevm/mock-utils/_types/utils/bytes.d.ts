...
export declare function assertIsBytes32String(value: unknown, valueName?: string): asserts value is `0x${string}`;
export declare function assertIsBytesString(value: unknown, width?: number, valueName?: string): asserts value is `0x${string}`;
