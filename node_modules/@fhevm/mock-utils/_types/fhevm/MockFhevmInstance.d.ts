...
import type { EIP712, FhevmInstance, HandleContractPair, PublicDecryptResults, PublicParams, UserDecryptResults } from "../relayer-sdk/types.js";
...
export declare class MockFhevmInstance implements FhevmInstance {
    ...
    userDecrypt(handles: HandleContractPair[], _privateKey: string, publicKey: string, signature: string, contractAddresses: string[], userAddress: string, startTimestamp: string | number, durationDays: string | number): Promise<UserDecryptResults>;
