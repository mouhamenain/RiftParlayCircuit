...
import type { FhevmInstance, UserDecryptResults } from "../relayer-sdk/types.js";
...
export declare function userDecryptHandleBytes32(instance: FhevmInstance, handleContractPairs: {
    ...
    fhevmType?: FhevmType;
}[], user: EthersT.Signer, options?: Omit<FhevmUserDecryptOptions, "instance">): Promise<UserDecryptResults>;
