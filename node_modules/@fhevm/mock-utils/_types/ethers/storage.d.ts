 ...
 */
export declare function getStorageAt(provider: MinimalProvider, address: string, index: bigint): Promise<`0x${string}`>;
 ...
 */
export declare function getAddressesFromStorage(provider: MinimalProvider, contractAddress: string, storageLocationBytes32: string, numAddresses: number): Promise<`0x${string}`[]>;
