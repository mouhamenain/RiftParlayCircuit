...
export declare function assertEventArgIsBytes1String(value: unknown, eventName: string, argIndex: number): asserts value is `0x${string}`;
export declare function assertEventArgIsBytes4String(value: unknown, eventName: string, argIndex: number): asserts value is `0x${string}`;
export declare function assertEventArgIsBytes8String(value: unknown, eventName: string, argIndex: number): asserts value is `0x${string}`;
export declare function assertEventArgIsBytes16String(value: unknown, eventName: string, argIndex: number): asserts value is `0x${string}`;
export declare function assertEventArgIsBytes32String(value: unknown, eventName: string, argIndex: number): asserts value is `0x${string}`;
export declare function assertEventArgIsBytesString(value: unknown, eventName: string, argIndex: number): asserts value is `0x${string}`;
